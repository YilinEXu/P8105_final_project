...
oo_map = leaflet::leaflet(data = fips_map_crs) %>% 
  ...
  addLegend('bottomleft',
            pal = percent_oo_pal,
            values = ~percent_oo,
            title = "The Average Percentage of Students Who were Overweight or Obese (2010-2019)",
            opacity = 1)
```
...
hamilton_df = 
  ...
  select(county, year_reported, grade_level, 
         percent_overweight_or_obese, percent_healthy_weight, sex) %>% 
