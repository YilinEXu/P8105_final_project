...
combine %>% 
  plot_ly(x = ~percent_overweight_or_obese, y = ~median_income, type = 'scatter', mode = 'markers', color = ~county, marker = list(size = ~percent_overweight_or_obese, opacity = 0.5))
...
combine %>% 
  plot_ly(x = ~county, y = ~median_income, type = 'scatter', mode = 'markers', color = ~median_income, marker = list(size = ~median_income, opacity = 0.1))
