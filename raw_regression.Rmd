...
- **Food Access Ability**: Food access ability in different counties
...
The graph below shows that more male students are in the overweight or obese category than female students in 2015 to 2016. Overall the ratio difference is not obvious. 
during datacleaning process find out there are outliers at 100 percent 
...
during data cleaning find outliers
...
From the graph we can see that there is a general trend that if the median income is low, the overweight or obese percent in students are higher. Three of the most richest county in NY have the least percentage in overweight or obese student, with Schuyler being the exception. 
...
There might exist a general trend that if the county has high minorities percentage, the the overweight or obese percent in students tend to be higher.
