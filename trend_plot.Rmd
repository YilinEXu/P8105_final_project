...
We are also interested about the ranking of counties that have highest overweight or obesity percentage among students. From this plot, we show the changes of the ranking of the top 20 counties that have the highest  overweight or obesity mean percentage in New York state through ten years. Some counties have the same percentage in one of the years, so their bars will lay over each other. 
