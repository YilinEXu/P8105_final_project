...
From the plot that showing the percentage of students' overweight or obese weight status, we can see that middle and high school students' overweight percentage is keep increasing over years. Students in elementary school, their overweight percentage is showing an overall decreasing trend. By looking at all grade level, we can see that the change of overweight or obese rate is small, basically stay around 34%.
...
## Overweight and obsesitytrend for students by gender from 2010 to 2019 in NY

From the plot that shows the percentage changing trend, we can see that the percentage of overweight or obesity of female students showing an overall increasing trend over ten years. The percentage of overweight or obesity of male students showing an overall decreasing trend over ten years. For the first two periods, both female and male have same changing trend. After that, their trend changed in negative direction.
...
genderperc <- maindata %>%
  ...
  geom_line(size = 1) + 
  geom_point(size = 2) + 
  labs(title = "Percentage trend of overweight or obesity by gender",
       subtitle = "Data was recorded for every two year periods",
       x = "Year", 
       y = "Percentage of overweight and obesity among students") +
  theme(axis.text.x = element_text(angle = 45)) %>%
...
From the plot that shows the number changing trend, we can see that the number of overweight or obesity of both genders are showing an overall increasing trend. It is interesting that their variation trend is quite similar where their trend is changing in the same direction.
...
gender_num <- maindata %>%
  ...
  geom_line(size = 1) + 
  geom_point(size = 2) + 
  labs(title = "Students' weights' number trend of overweight or obesity by gender",
       subtitle = "data was recorded for every two year periods.",
       x = "Year", 
