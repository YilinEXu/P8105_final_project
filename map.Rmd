...
getJenksBreaks(fips_map$average, 8)

# set bins
average_bins <- c(26,30,32,34,36,38,40,43)

# set pals
average_pal <- colorBin('Greens', bins = average_bins, na.color = '#aaff56')
```

## The Average Percentage of Overweight or Obesity in Each County
```{r, echo = FALSE}
# choropleth map
